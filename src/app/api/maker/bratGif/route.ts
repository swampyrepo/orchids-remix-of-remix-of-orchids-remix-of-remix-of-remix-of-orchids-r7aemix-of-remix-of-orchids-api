...
export async function GET(req: NextRequest) {
  ...
  try {
    const targetUrl = `http://anabot.my.id/api/maker/bratGif?text=${encodeURIComponent(text)}&apikey=${apikey}`;
    ...
    console.error("Brat Gif API Error:", error);
